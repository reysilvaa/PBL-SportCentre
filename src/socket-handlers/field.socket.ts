 ...
 */
export const handleCheckAllFieldsAvailability = async (socket: Socket, data: any, callback?: Function) => {
  try {
 ...
 */
export const handleCheckFieldAvailability = async (socket: Socket, data: any, callback?: Function) => {
  try {
 ...
 */
export const handleGetAvailableTimeSlots = async (socket: Socket, data: any, callback?: Function) => {
  try {
