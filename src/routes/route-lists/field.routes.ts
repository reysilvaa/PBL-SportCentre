...
router.post('/admin', branchAdminAuth, adminBranchMiddleware, parseIds, createField);
router.put('/admin/:id', branchAdminAuth, adminBranchMiddleware, parseIds, updateField);
...
router.post('/', superAdminAuth, parseIds, createField);
router.put('/:id', superAdminAuth, parseIds, updateField);
