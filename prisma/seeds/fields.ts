    ...
    data: [
      {
        ...
        typeId:
          fieldTypes.find((ft) => ft.name === 'Futsal')?.id || fieldTypes[0].id,
        name: 'Futsal Field A',
        priceDay: 100000,
        priceNight: 150000,
      ...
      },
      {
        branchId: branches[0].id,
        typeId:
          fieldTypes.find((ft) => ft.name === 'Basketball')?.id ||
          fieldTypes[1].id,
      ...
      },
      {
        ...
        typeId:
          fieldTypes.find((ft) => ft.name === 'Badminton')?.id ||
          fieldTypes[2].id,
      ...
      },
      {
        branchId: branches[1].id,
        typeId:
          fieldTypes.find((ft) => ft.name === 'Tennis')?.id || fieldTypes[3].id,
        name: 'Tennis Court 1',
        priceDay: 150000,
        priceNight: 200000,
        status: FieldStatus.available,
